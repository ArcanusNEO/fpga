...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/1_decoder3_8/1_decoder3_8/1_decoder3_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8.vdi -applog -m64 -messageDb vivado.pb -mode batch -source decoder3_8.tcl -notrace
