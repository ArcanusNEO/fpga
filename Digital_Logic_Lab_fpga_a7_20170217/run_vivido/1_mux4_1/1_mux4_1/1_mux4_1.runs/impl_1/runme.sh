...
HD_PWD='D:/fpga/Digital_Logic_Lab_fpga_a7_20170217/run_vivido/1_mux4_1/1_mux4_1/1_mux4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4_1.tcl -notrace
