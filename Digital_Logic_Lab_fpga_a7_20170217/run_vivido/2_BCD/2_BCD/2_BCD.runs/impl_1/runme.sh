...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/2_BCD/2_BCD/2_BCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD.vdi -applog -m64 -messageDb vivado.pb -mode batch -source BCD.tcl -notrace
