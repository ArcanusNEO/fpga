...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/2_BCD/2_BCD/2_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD.vds -m64 -mode batch -messageDb vivado.pb -notrace -source BCD.tcl
