...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/3_edge_t_flipflop/3_edge_t_flipflop/3_edge_t_flipflop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_t_flipflop.vdi -applog -m64 -messageDb vivado.pb -mode batch -source edge_t_flipflop.tcl -notrace
