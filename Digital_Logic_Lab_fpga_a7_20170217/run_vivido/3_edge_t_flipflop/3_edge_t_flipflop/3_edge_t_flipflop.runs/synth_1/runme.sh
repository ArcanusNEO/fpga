...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/3_edge_t_flipflop/3_edge_t_flipflop/3_edge_t_flipflop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_t_flipflop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source edge_t_flipflop.tcl
