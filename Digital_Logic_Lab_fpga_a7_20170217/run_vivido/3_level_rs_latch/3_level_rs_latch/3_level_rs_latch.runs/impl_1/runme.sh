...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/3_level_rs_latch/3_level_rs_latch/3_level_rs_latch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log level_rs_latch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source level_rs_latch.tcl -notrace
