...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/3_pulse_jk_flipflop/3_pulse_jk_flipflop/3_pulse_jk_flipflop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_jk_flipflop.vdi -applog -m64 -messageDb vivado.pb -mode batch -source pulse_jk_flipflop.tcl -notrace
