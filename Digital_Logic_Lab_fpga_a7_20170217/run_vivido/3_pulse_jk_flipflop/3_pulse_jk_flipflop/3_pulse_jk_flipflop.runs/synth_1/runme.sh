...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/3_pulse_jk_flipflop/3_pulse_jk_flipflop/3_pulse_jk_flipflop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulse_jk_flipflop.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pulse_jk_flipflop.tcl
