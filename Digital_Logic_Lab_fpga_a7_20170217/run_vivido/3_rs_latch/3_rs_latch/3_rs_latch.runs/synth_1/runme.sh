...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/3_rs_latch/3_rs_latch/3_rs_latch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs_latch.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rs_latch.tcl
