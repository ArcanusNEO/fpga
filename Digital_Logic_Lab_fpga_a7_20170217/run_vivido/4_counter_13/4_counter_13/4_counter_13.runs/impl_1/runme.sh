...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/4_counter_13/4_counter_13/4_counter_13.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_13.vdi -applog -m64 -messageDb vivado.pb -mode batch -source counter_13.tcl -notrace
