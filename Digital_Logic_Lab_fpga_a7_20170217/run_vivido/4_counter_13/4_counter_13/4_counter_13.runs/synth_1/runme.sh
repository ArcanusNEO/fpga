...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/4_counter_13/4_counter_13/4_counter_13.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_13.vds -m64 -mode batch -messageDb vivado.pb -notrace -source counter_13.tcl
