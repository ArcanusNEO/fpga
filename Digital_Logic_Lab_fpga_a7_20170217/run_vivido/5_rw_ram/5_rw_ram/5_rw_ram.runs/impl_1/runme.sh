...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/5_rw_ram/5_rw_ram/5_rw_ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rw_ram.vdi -applog -m64 -messageDb vivado.pb -mode batch -source rw_ram.tcl -notrace
