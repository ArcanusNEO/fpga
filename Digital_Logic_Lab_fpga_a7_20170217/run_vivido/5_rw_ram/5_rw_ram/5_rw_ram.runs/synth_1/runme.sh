...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/5_rw_ram/5_rw_ram/5_rw_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rw_ram.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rw_ram.tcl
