...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/6_watch/6_watch/6_watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log watch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source watch.tcl -notrace
