...
HD_PWD='/home/innovril/digital_logic_lab/run_vivido/6_watch/6_watch/6_watch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log watch.vds -m64 -mode batch -messageDb vivado.pb -notrace -source watch.tcl
